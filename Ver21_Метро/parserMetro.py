...
wb = openpyxl.load_workbook("flatsWithMetrotime7777.xlsx")
ws = wb.active
...
metro_ratings = {
    ...
    "Рабочий посёлок": 7,  # Не очень популярная станция
...
wb.save("flats_with_metro_ratings77777.xlsx")
